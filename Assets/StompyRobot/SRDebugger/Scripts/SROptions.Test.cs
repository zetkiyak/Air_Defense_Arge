...
#region Options Panel
    ...
    public void PrevLevel()
    {
        if (PlayerPrefs.GetInt("currentLevel", 0) != 0)
        {
            ...
            PlayerPrefs.SetInt("currentLevelText", PlayerPrefs.GetInt("currentLevel"));
    ...
    {
        if (PlayerPrefs.GetInt("currentLevel", 0) != LevelManager.Instance.levelsParent.transform.childCount - 1)
        {
            PlayerPrefs.SetInt("currentLevel", PlayerPrefs.GetInt("currentLevel") + 1);
            PlayerPrefs.SetInt("currentLevelText", PlayerPrefs.GetInt("currentLevel"));
    ...
    public void GoTargetLevel()
    {
        if (PlayerPrefs.GetInt("TargetLevel") != 0)
        {
            PlayerPrefs.SetInt("currentLevel", PlayerPrefs.GetInt("TargetLevel") - 1);
            PlayerPrefs.SetInt("currentLevelText", PlayerPrefs.GetInt("currentLevel"));
        }
        else
        {
    ...
    public double TestDouble
    {
        ...
        set
        {
            OnValueChanged("TestDouble", (float)value);
            _testDouble = value;
        }
    }
    ...
    public TestValues TestEnum
    {
        ...
        set
        {
            OnValueChanged("TestEnum", (float) value);
            _testEnum = value;
        }
    }
