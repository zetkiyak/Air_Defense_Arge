	...
	SubShader
	{
		...
		#pragma shader_feature _ _ALPHAPREMULTIPLY_ON
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				color.rgb = ( color.rgb * input.vertexColor.rgb );
...
/* TCP_DATA u config(unity:"2020.2.6f1";ver:"2.7.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","CLAMP_LIGHTS_INTENSITY","RIM_VERTEX","RIM_LIGHTMASK","RIM_SHADER_FEATURE","RIM_DIR","OCCLUSION","AMBIENT_VIEW_DIR","VERTEX_DISP_SHADER_FEATURE","TT_SHADER_FEATURE","OUTLINE_URP_FEATURE","VERTICAL_FOG_ALPHA","VERTICAL_FOG_COLOR","SSAO","FOG","ENABLE_LIGHTMAP","SUBSURFACE_AMB_COLOR","SS_NO_LIGHTCOLOR","SS_SHADER_FEATURE","SS_MULTIPLICATIVE","SHADOW_HSV_MASK","MATCAP_PERSPECTIVE_CORRECTION","MATCAP_SHADER_FEATURE","ALBEDO_HSV","SPECULAR_NO_ATTEN","SPECULAR_SHADER_FEATURE","DIFFUSE_TINT","AUTO_TRANSPARENT_BLENDING","ZTEST","ATTEN_AT_NDL","REFL_ROUGH","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting",VERTEXMOTION_INCLUDE="Assets/VertExmotion/Shaders/VertExmotion.cginc"];shaderProperties:list[,,,,,,,,,,,,,,,,sp(name:"Depth Test";imps:list[imp_enum(value_type:1;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.CompareFunction";guid:"ecbc69ff-93a8-4f16-83d9-f879309407a3";op:Multiply;lbl:"Depth Test";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,,,,sp(name:"Final Color";imps:list[imp_hook(guid:"2ded1947-3a18-468d-9e05-c8a4ed7a50b3";op:Multiply;lbl:"color.rgb";gpu_inst:False;locked:False;impl_index:0),imp_vcolors(cc:3;chan:"RGB";guid:"c7e4344e-4123-40dd-9a07-338b234846a7";op:Multiply;lbl:"Final Color";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 1939457fe445ef80bfce5e6e6f4c04a6 */
